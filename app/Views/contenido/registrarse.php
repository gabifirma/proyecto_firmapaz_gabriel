<section class="formulario-registrarse row g-3 mt-5 needs-validation container-fluid" id="contacto">
    ...
    <form action="<?php echo base_url('registro_cliente') ?>" method="post" autocomplete="off" class="card text-center formulario-login container-fluid mb-5" style="width: 45rem; margin-top: 5%">
    <div class="d-flex flex-column align-items-center">
        <div class="col-md-5 mt-3 w-100">
